...
- **Pretalx pre-event announcer**: broadcasts each session (time, room, title, speakers) to the bound channel(s) a configurable number of minutes before it starts, deduped across restarts
